...
import com.lw.enumeration.user.UserStateEnum;
import com.lw.enumeration.user.UserTypeEnum;
...
public class UserEntity implements Serializable {
    ...
    /** 用户类型 {@link com.lw.enumeration.user.UserTypeEnum} */
    private UserTypeEnum userTypeEnum;

    /** 账号状态 {@link com.lw.enumeration.user.UserStateEnum} */
